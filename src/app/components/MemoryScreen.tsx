...
const typeColors: Record<string, { primary: string; bg: string; light: string }> = {
  long_term: { primary: "#8B5CF6", bg: "rgba(139, 92, 246, 0.15)", light: "rgba(139, 92, 246, 0.1)" },
  daily: { primary: "#06B6D4", bg: "rgba(6, 182, 212, 0.15)", light: "rgba(6, 182, 212, 0.1)" },
  project: { primary: "#10B981", bg: "rgba(16, 185, 129, 0.15)", light: "rgba(16, 185, 129, 0.1)" },
  system: { primary: "#F59E0B", bg: "rgba(245, 158, 11, 0.15)", light: "rgba(245, 158, 11, 0.1)" },
};
...
function MemoryCard({ memory, index, onClick }: { 
  ...
  return (
    ...
    >
      ...
      {/* 内容 */}
      <h3 className="font-semibold text-white group-hover:text-[#3B82F6] transition-colors mb-2 line-clamp-1">
        {memory.title}
      </h3>
  ...
  return (
    ...
    >
      ...
      >
        {/* 头部 */}
        <div 
          className="p-6 border-b border-white/10 sticky top-0 bg-[#111118]/95 backdrop-blur-sm"
